...
export const AuthorCard = ({
  ...
  return (
    <div
      className={`flex flex-col justify-between p-8 md:p-10 rounded-[28px] bg-[#111113] border border-white/[0.05] shadow-2xl w-[340px] sm:w-[420px] shrink-0 ${className}`}
    >
      <p className="text-[#9898A0] text-[18px] leading-[1.7] mb-12 font-light tracking-wide flex-1">
        {quote}
      </p>

      <div className="flex items-center gap-4">
        <div className="relative w-[52px] h-[52px] rounded-full overflow-hidden border-[2px] border-[#EAEAEA] shrink-0 shadow-sm">
